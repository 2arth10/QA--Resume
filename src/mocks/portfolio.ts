...
export const skillsToolData = [
  {
    category: 'Office',
    items: [
      { name: '구글시트', icon: 'simple-icons:googlesheets', color: '#34A853', proficiency: 8, desc: '데이터 정리 및 함수 활용 가능' },
      { name: '엑셀', icon: 'vscode-icons:file-type-excel', proficiency: 7, desc: '기본 함수 및 표 작성 가능' },
      { name: '워드', icon: 'vscode-icons:file-type-word', proficiency: 8, desc: '문서 작성 및 서식 편집 가능' },
  ...
  },
  {
    ...
    items: [
      { name: '슬랙', icon: 'logos:slack-icon', proficiency: 8, desc: '채널 관리 및 협업 소통 가능' },
      { name: '노션', icon: 'simple-icons:notion', proficiency: 9, desc: '문서화 및 프로젝트 관리 가능' },
      { name: 'JIRA', icon: 'logos:jira', proficiency: 7, desc: '이슈 등록 및 스프린트 관리 가능' },
      { name: '깃허브', icon: 'mdi:github', proficiency: 6, desc: '기본 커밋·푸시·브랜치 관리 가능' },
    ],
  },
  {
    category: 'AI Tools',
  ...
  },
  {
    category: 'Design',
    items: [
      { name: '피그마', icon: 'logos:figma', proficiency: 7, desc: 'UI 디자인 및 프로토타입 제작 가능' },
      { name: '포토샵', icon: 'skill-icons:photoshop', proficiency: 6, desc: '이미지 편집 및 보정 가능' },
      { name: '일러스트', icon: 'skill-icons:illustrator', proficiency: 6, desc: '벡터 그래픽 및 아이콘 제작 가능' },
      { name: '클립스튜디오', icon: '', img: '/클립스튜디오_로고.png', proficiency: 7, desc: '디지털 드로잉 및 일러스트 제작' },
    ],
  },
  {
    category: 'Tech',
    items: [
      { name: 'HTML5', icon: 'logos:html-5', proficiency: 7, desc: '마크업 구조 작성 가능' },
      { name: 'CSS3', icon: 'logos:css-3', proficiency: 7, desc: '스타일링 및 레이아웃 구성 가능' },
      { name: '파이썬', icon: 'logos:python', proficiency: 5, desc: '기초 스크립트 및 자동화 작성 가능' },
