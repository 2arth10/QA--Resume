...
export const careerData = {
  items: [
    ...
    {
      title: '게임QA 교육 이수',
      subtitle: '게임 QA 직무 이해 및 실무 흐름 학습',
      period: '2025.11.11 ~ 2025.12.15',
      description: '게임 QA 전문 교육 과정을 통해 QA 직무에 필요한 사고방식과 테스트 전반의 흐름을 학습했습니다.\n실무 현장의 업무 방식과 프로세스를 중심으로, QA가 게임 개발 과정에서 어떤 역할을 수행하고 협업하는지 실질적인 이해를 쌓았습니다.',
      tags: ['# 게임QA', '# 교육이수'],
      type: 'education',
    ...
    },
    {
      ...
      description: '컴투스에서 진행한 QA 캠퍼스 8기 교육 과정을 수료했습니다.\n 버그 리포트 작성 방법, TC(테스트 케이스) 작성법, 게임 납품 프로세스, 게임 분석 방법 등\n 실무 중심의 QA 커리큘럼을 통해 현장에서 바로 적용 가능한 역량을 쌓았습니다.',
    ...
    },
    {
      ...
      description: '웹 표준을 기반으로 한 스마트 UI/UX 디자인 및 웹 퍼블리셔 과정을 수료했습니다.\n 기획부터 디자인, 개발, QA까지 웹 전 과정을 직접 수행하며 API 연동, 반응형 웹, Python 등의 기술을 실습했습니다.',
    ...
    },
    {
      ...
      subtitle: '한국생산성본부(KPC) 공식 자격증',
      period: '2023.06.16',
      description: 'GTQ(Graphic Technology Qualification) 그래픽기술자격 1급을 취득했습니다.',
      tags: ['# GTQ', '# 1급', '# 자격증', '# 포토샵'],
      type: 'education',
    ...
    {
      title: '청강문화산업대학교',
      subtitle: '패션디자인 (학사) 3.6/4.5',
      period: '2019.03 ~ 2023.02',
      description: '청강문화산업대학교 패션디자인 3년제 과정 졸업 후, 전공심화로 학사를 취득했습니다.\n2020년에는 게임과 졸업 작품 [pepo]와 굿즈 콜라보 프로젝트를 진행했습니다. 게임과 졸업 팀과 협업하여 실제 게임 기획 파일, 캐릭터 설정, UI 이미지 등을 기반으로 게임의 세계관과 디자인을 분석하고, 이를 반영한 굿즈 디자인을 직접 제작했습니다.',
    ...
    },
    {
      ...
      subtitle: '전국 보드게임 대회',
      period: '2017.06.22',
      description: '전국 보드게임 대회 스플렌더 일반부 부문 본선에 진출했습니다.',
      tags: ['# 보드게임', '# 스플렌더', '# 본선진출'],
      type: 'education',
    ...
    },
    {
      ...
      subtitle: '패션디자인과',
      period: '2016 ~ 2019',
      description: '졸업 패션쇼에서 조장을 맡아 팀원들과의 협동과 소통을 이끌며, 리더십과 팔로워십을 동시에 경험했습니다.',
      tags: ['# 디자인고', '# 졸업'],
      type: 'education',
      icon: 'ri-school-line',
      sideIcon: 'ri-graduation-cap-fill',
  ...
  issueReports: [
    {
      id: 'FF14-001',
      title: '파이널판타지14',
      subtitle: '소장품 거래에서 레벨91~100 수산물을 납품했을 때 [로웨나 상회의 거래처] 업적에 집계되지 않는 현상',
      type: 'MMORPG',
      date: '2025.10.26',
      status: '완료',
    ...
    },
    {
      id: 'DS-001',
      title: '드래곤 소드',
      subtitle: 'AOS/IOS 게스트 로그인 팝업 취소 후 재노출 불가 현상',
      type: '오픈월드 액션 RPG',
      date: '2026.01.21',
      status: '완료',
    ...
    },
    {
      id: 'CZ-001',
      title: '카오스 제로 나이트 메어',
      subtitle: '홈 배경 [메이린] 설정 시 특정 대사 말풍선 및 텍스트 출력 잘림 현상(4개 국어 공통)',
      type: '루프 RPG',
      date: '2026.01.19',
      status: '완료',
    ...
    },
    {
      id: 'YY-001',
      title: '연운',
      subtitle: 'NPC와 대화 시 일부 UI 가 잘려 출력되는 현상',
      type: '액션 어드벤처 RPG',
      date: '2026.01.29',
      status: '완료',
      characterImg: '/연운.png',
    },
    {
      id: 'MB-001',
      title: '마비노기 모바일',
      subtitle: '가방에서 패션 확장 팝업창 띄운 후 ESC 버튼을 누르면 팝업창은 유지되고 가방에서 나가지는 현상',
      type: 'MMORPG',
      date: '2026.04.15',
      status: '완료',
